        ...
        <div className={styles.overlay}>
            <div className={clsx(styles.modal, isOpen && styles.open)}>
                ...
                <div className={styles.tabs}>
                    <button className={clsx(styles.tab, activeTab === 'profile' && styles.activeTab)} onClick={() => setActiveTab('profile')}><User size={16} /> Profile</button>
                    <button className={clsx(styles.tab, activeTab === 'theme' && styles.activeTab)} onClick={() => setActiveTab('theme')}><Palette size={16} /> Theme</button>
                    <button className={clsx(styles.tab, activeTab === 'api' && styles.activeTab)} onClick={() => setActiveTab('api')}><Key size={16} /> API</button>
                </div>
                    ...
                    {activeTab === 'profile' && (
                        <div className={styles.profileTab}>
                            ...
                            <div className={styles.group}>
                                <label className={styles.label} htmlFor="profileName">Display Name (Nickname)</label>
                                <input
                                    id="profileName"
                                    ...
                                    maxLength={32}
                                />
                                <div className={styles.inputHint}>This is your nickname and how Zizzy will greet you. You can change it anytime.</div>
                            </div>
                            {userEmail && (
                                <div className={styles.group}>
